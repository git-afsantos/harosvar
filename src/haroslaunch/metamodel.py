...
class RosName(object):
    ...
    def __repr__(self):
        return f'{type(self).__name__}({repr(self._own)}, ns={repr(self._ns)})'
...
class RosNode(RosResource):
    ...
    def __init__(
        ...
        super(RosNode, self).__init__(name, system=system, condition=condition, location=location)
        self.package = pkg
        self.executable = exe
    ...
    def to_JSON_object(self):
        return {
            ...
            'condition': self.condition.to_JSON_object(),
            'is_test_node': False,
...
class RosTest(RosResource):
    ...
    def __init__(
        ...
        super(RosTest, self).__init__(name, system=system, condition=condition, location=location)
...
class RosParameter(RosResource):
    ...
    def __init__(self, name, param_type, value, system=None, condition=None, location=None):
        super(RosParameter, self).__init__(
            name, system=system, condition=condition, location=location
        )

...
from .launch_interpreter import LaunchInterpreter
...
def parse_args(argv):
    parser = ArgumentParser(
        prog='haroslaunch', description='ROS launch file parser and interpreter'
    )
    parser.add_argument('launch_files', metavar='file', nargs='+', help='target ROS launch files')
